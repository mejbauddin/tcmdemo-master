...
<template>
  <div class="space-y-8 animate-fade-in-up">
    ...
    <section class="text-center space-y-4">
      ...
      <!-- Personalized Welcome - FIXED to show username properly -->
      <div class="mb-2">
        <h2 class="text-xl md:text-2xl font-medium text-stone-600">
          {{ getGreeting() }},
          <span class="font-bold text-red-600 text-2xl md:text-3xl">{{ authStore.isAuthenticated ? authStore.user?.username : 'Guest' }}</span>!
        </h2>
      </div>
    ...
    <!-- Dialogue / Content - EXACTLY from the design doc -->
